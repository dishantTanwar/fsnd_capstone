...
# main_app
# "postgresql://db_setup["user_name"]:dbsetup["password"]@{}/{}"
# .format(db_setup["port"] db_setup["database_name_production"])


db_setup = {
    "database_name_production": "DATABASE_URL",
    "database_name_test": "capstone_test_db",
    "user_name": "postgres",  # default postgres username
    "password": "postgres",  # If no password is there then set value to None
